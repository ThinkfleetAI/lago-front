        ...
        return (
          <Table
            ...
            data={[
              ...
              // filter (rare; backend builder excludes filter-related fees
              // from groupedUsage.{,projected}presentationBreakdowns).
              ...makeBreakdownRows(
            ...
            columns={[
              ...
              },
              {
                ...
                content: (row) => {
                  ...
                  // Reconcile parent units with the sum of breakdowns for the
                  // active tab so the parent + listed breakdowns are
                  // consistent on both Current and Projected tabs.
                  ...
                  const displayUnits = hasBreakdowns ? sumBreakdownUnits(breakdowns) : rawUnits
