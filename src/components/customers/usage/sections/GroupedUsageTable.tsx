      ...
      columns={[
        ...
        },
        {
          ...
          content: (row) => {
            ...
            // Display the breakdowns sum on both tabs so the parent reconciles
            // with the listed breakdown rows below it. Note: for non-additive
            // aggregations like max/unique_count the underlying GraphQL `units`
            // value does not equal sum(breakdowns), so the sum is intentional.
